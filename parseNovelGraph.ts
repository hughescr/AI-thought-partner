...
const coreEmbeddings: OllamaEmbeddings = new OllamaEmbeddings({ model: 'nomic-embed-text', numCtx: 2048 });
...
const mistralLargeLLMChat: ChatOllama = new ChatOllama({ model: 'mistral-large:latest', ...commonOptions64k });
