...
export const deepseekR1_Qwen7bLLM = new ChatOpenAI({ model: 'deepseek-r1-distill-qwen-7b', configuration: { baseURL: 'http://localhost:1234/v1' } });
export const deepseekR1_Llama8bLLM = new ChatOpenAI({ model: 'deepseek-r1-distill-llama-8b', configuration: { baseURL: 'http://localhost:1234/v1' } });
